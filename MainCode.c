...
#pragma config(Motor,  port6,           LDrive,        tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           LTower,        tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port8,           RTower,        tmotorVex393_MC29, PIDControl, encoderPort, I2C_2)
#pragma config(Motor,  port9,           LDrive,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          CFlipper,      tmotorVex393_HBridge, openLoop, reversed)
